...
QT_MOC_LITERAL(1, 8, 17), // "create_connection"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "std::string"
QT_MOC_LITERAL(4, 39, 15), // "stop_connection"
QT_MOC_LITERAL(5, 55, 15) // "get_disconneted"

    },
    "Threads\0create_connection\0\0std::string\0"
    "stop_connection\0get_disconneted"
};
...
void Threads::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->create_connection((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 1: _t->stop_connection((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        case 2: _t->get_disconneted((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Threads::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Threads::create_connection)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Threads::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Threads::stop_connection)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Threads::create_connection(std::string _t1)
{
...
// SIGNAL 1
void Threads::stop_connection(std::string _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
